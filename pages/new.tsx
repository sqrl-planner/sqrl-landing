                        ...
                        <div>
                            ...
                            <div className="mt-20">
                                <a href="#" className="inline-flex space-x-4">
                                    <span className="inline-flex items-center text-xl font-medium space-x-1 text-tahiti-700">
                                        <span>
                                            Sqrl is <span className="text-tahiti-900 text-opacity-60">(almost)</span> here. Try the alpha release -&gt;
                                        </span>
                                    </span>
                                </a>
                            </div>
                            <div className="mt-6">
                                <h1 className="mt-4 sm:text-5xl text-4l font-extrabold text-gray-900 tracking-tight">
                            ...
                            <form action="#" className="mt-12 sm:max-w-lg sm:w-full sm:flex">
                                <div className="min-w-0 flex-1">
                                    ...
                                    <input
                                        id="email"
                                        type="email"
                                        className="block w-full border border-gray-300 rounded-md px-5 py-3 text-base text-gray-900 placeholder gray-500 shadow-sm focus:border-tahiti-600 focus:ring-tahiti-600" placeholder="meric.gertler@mail.utoronto.ca"
                                    />
                                </div>
